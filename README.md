...
* Download this installer, make it executable and run it
  ...
  ```shell
 sudo bash -c "wget https://raw.githubusercontent.com/i-machine-things/debian-kiosk-installer/master/kiosk-installer.sh && chmod +x kiosk-installer.sh && ./kiosk-installer.sh"
  ```
